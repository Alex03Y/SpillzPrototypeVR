...
namespace NaughtyAttributes.Editor
{
    public static class EditorDrawUtility
    {
        ...
        {
            var headerAttr = PropertyUtility.GetAttribute<HeaderAttribute>(property);
        ...
        public static void DrawHelpBox(string message, MessageType type, Object context = null,

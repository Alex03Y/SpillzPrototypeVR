...
//[PerRendererData]
    Properties 
	{
		...
		[PerRendererData] _OutlineColor ("Outline Color", Color) = (0,245,245,250)
		[PerRendererData] _OutlineWidth ("Outline width", Range (.000, 0.03)) = .000
...
//		UsePass "Standard/FORWARD"
		UsePass "Mobile/Diffuse/FORWARD"
